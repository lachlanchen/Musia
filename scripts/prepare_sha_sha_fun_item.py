...
def write_media_item() -> None:
    ...
    manifest = {
        ...
        "provenance": {
            "audio": "ACE-Step 1.5 XL Turbo seed 750531 selected after ASR/listening review.",
            "lyrics": "ASR/STT/listening-corrected Chinese active track; close user-confirmed phrases such as 好多的沙 and 轻指楼兰姑娘面庞 preserve the intended lyric over nearby ASR guesses.",
            "cover": "Generated by scripts/prepare_sha_sha_fun_item.py as a 16:9 sunset beach/desert procedural cover with two walking silhouettes and no text.",
        },
        "share": {
