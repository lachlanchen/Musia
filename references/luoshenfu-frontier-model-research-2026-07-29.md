...
后续复核：[2026-09-13 模型与社区更新](music-generation-community-update-2026-09-13.md)。
新增 MiniMax Music 3、YuE2 / SheetSage2，并发现 ACE 后续修复了可能导致
非 Turbo 模型噪声的 DCW 默认设置。本文保留当时的实测结果；SFT 应在修复后的
受控条件下重新比较，不能把旧运行结果当作对模型质量的永久结论。
